...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/freexlib-todolist)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/freexlib-todolist#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/freexlib-todolist
```

A live public deployment of this template is available at [https://freexlib-todolist.templates.workers.dev](https://freexlib-todolist.templates.workers.dev)
